...
class Clock_validateTest(unittest.TestCase):
	...
	def test_hour(self):
		...
		self.assertRaises(chrono.HourError, chrono.clock.Clock.validate, 25, 37, 43)

	def test_minute(self):
		"Clock.validate() raises MinuteError on invalid minute"

		self.assertRaises(chrono.MinuteError, chrono.clock.Clock.validate, 16, 65, 43)

	def test_second(self):
		"Clock.validate() raises SecondError on invalid second"

		self.assertRaises(chrono.SecondError, chrono.clock.Clock.validate, 16, 37, 84)
...
class Clock_validate_hourTest(unittest.TestCase):
	...
	def test_24(self):
		...
		self.assertRaises(chrono.HourError, chrono.clock.Clock.validate_hour, 24)

	def test_negative(self):
		"Clock.validate_hour() raises HourError on negative values"

		self.assertRaises(chrono.HourError, chrono.clock.Clock.validate_hour, -1)
...
class Clock_validate_minuteTest(unittest.TestCase):
	...
	def test_24(self):
		...
		self.assertRaises(chrono.MinuteError, chrono.clock.Clock.validate_minute, 60)

	def test_negative(self):
		"Clock.validate_minute() raises MinuteError on negative values"

		self.assertRaises(chrono.MinuteError, chrono.clock.Clock.validate_minute, -1)
...
class Clock_validate_secondTest(unittest.TestCase):
	...
	def test_24(self):
		...
		self.assertRaises(chrono.SecondError, chrono.clock.Clock.validate_second, 60)

	def test_negative(self):
		"Clock.validate_second() raises SecondError on negative values"

		self.assertRaises(chrono.SecondError, chrono.clock.Clock.validate_second, -1)
