...
class intTest(unittest.TestCase):
	...
	def test_int(self):
		"integer() converts integer to integer"
...
class int_dayTest(unittest.TestCase):
	...
	def test_none(self):
		...
		self.assertRaises(chrono.error.DayError, chrono.utility.int_day, None)

	def test_nonnumeric(self):
		"int_day() raises DayError on non-numeric string"

		self.assertRaises(chrono.error.DayError, chrono.utility.int_day, "abc")
...
class int_hourTest(unittest.TestCase):
	...
	def test_none(self):
		...
		self.assertRaises(chrono.error.HourError, chrono.utility.int_hour, None)

	def test_nonnumeric(self):
		"int_hour() raises HourError on non-numeric string"

		self.assertRaises(chrono.error.HourError, chrono.utility.int_hour, "abc")
...
class int_minuteTest(unittest.TestCase):
	...
	def test_none(self):
		...
		self.assertRaises(chrono.error.MinuteError, chrono.utility.int_minute, None)

	def test_nonnumeric(self):
		"int_minute() raises MinuteError on non-numeric string"

		self.assertRaises(chrono.error.MinuteError, chrono.utility.int_minute, "abc")
...
class int_monthTest(unittest.TestCase):
	...
	def test_none(self):
		...
		self.assertRaises(chrono.error.MonthError, chrono.utility.int_month, None)

	def test_nonnumeric(self):
		"int_month() raises MonthError on non-numeric string"

		self.assertRaises(chrono.error.MonthError, chrono.utility.int_month, "abc")
...
class int_secondTest(unittest.TestCase):
	...
	def test_none(self):
		...
		self.assertRaises(chrono.error.SecondError, chrono.utility.int_second, None)

	def test_nonnumeric(self):
		"int_second() raises SecondError on non-numeric string"

		self.assertRaises(chrono.error.SecondError, chrono.utility.int_second, "abc")
...
class int_weekTest(unittest.TestCase):
	...
	def test_none(self):
		...
		self.assertRaises(chrono.error.WeekError, chrono.utility.int_week, None)

	def test_nonnumeric(self):
		"int_week() raises WeekError on non-numeric string"

		self.assertRaises(chrono.error.WeekError, chrono.utility.int_week, "abc")
...
class int_yearTest(unittest.TestCase):
	...
	def test_none(self):
		...
		self.assertRaises(chrono.error.YearError, chrono.utility.int_year, None)

	def test_nonnumeric(self):
		"int_year() raises YearError on non-numeric string"

		self.assertRaises(chrono.error.YearError, chrono.utility.int_year, "abc")
